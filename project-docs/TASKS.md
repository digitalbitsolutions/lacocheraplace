...
- Piloto Detailing Center: provider profile y cinco servicios con precios PEN creados en Shopify el `2026-09-01`; productos en `DRAFT`, pendientes de datos reales, imágenes y aprobación de publicación
