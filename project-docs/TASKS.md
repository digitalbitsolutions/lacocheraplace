...
- Piloto Detailing Center: provider profile y cinco servicios con precios PEN creados y publicados en `Online Store` el `2026-09-01`; URLs verificadas HTTP 200, pendientes de datos reales, imágenes y QA visual
